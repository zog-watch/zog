...
description: Common issues and solutions for self-hosting Zog.
---

There is always a possibility for something to go wrong while trying to deploy your own instance of Zog. This page will contain common issues people have come across while self-hosting and their solutions.
...
It is likely that you haven't installed the PWA version of Zog. Please read the [upgrade guide](/client/upgrade) for more details on the matter.
