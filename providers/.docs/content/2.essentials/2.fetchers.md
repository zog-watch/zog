...
The zog team has a proxy pre-made and pre-configured for you to use. For more information, check out [zog/simple-proxy](https://github.com/zog-watch/simple-proxy). After installing, you can use this proxy like so:
...
It's not recommended to do this at all. If you have to, you can base your code on the original implementation of `makeStandardFetcher`. Check out the [source code for it here](https://github.com/zog-watch/providers/blob/dev/src/fetchers/standardFetch.ts).
