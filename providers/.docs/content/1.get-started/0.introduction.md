...
## What is `@zog/providers`?

`@zog/providers` is the soul of [zog](https://github.com/zog-watch/zog). It's a collection of scrapers of various streaming sites. It extracts the raw streams from those sites, so you can watch them without any extra fluff from the original sites.
